...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/04/20 05:33:56 by bnoufel           #+#    #+#             */
/*   Updated: 2021/04/20 05:33:57 by bnoufel          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		assing_md5(t_md5 *md5, size_t offset)
{
	int			i;
...
t_md5			*ft_md5(uint8_t *str, size_t size_line)
{
	...
	{
		assing_md5(md5, offset);
		offset += 64;
	}
	ft_asprintf(&md5->hash, "%08x%08x%08x%08x", revers_uint32(md5->h0),
		revers_uint32(md5->h1), revers_uint32(md5->h2), revers_uint32(md5->h3));
	ft_strdel(&md5->msg);
	return (md5);
}
